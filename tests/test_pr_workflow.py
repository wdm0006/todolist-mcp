...
def test_pr_status_reporting(temp_db):
    ...
    item3 = add_item("Add tests C", priority="low", tags="testing")
...
def test_pr_cleanup_workflow(temp_db):
    ...
    item2 = add_item("Important feature", priority="high")
...
def test_pr_due_date_management(temp_db):
    ...
    result = add_item(
        description="Feature for Q1 release",
        priority="high",
        due_date_str="2024-03-31",
        tags="feature,q1-release"
    )
